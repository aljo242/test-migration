...
import TestMigrationTestmigrationTestmigration from './test-migration/testmigration.testmigration'
...
export default { 
  ...
  TestMigrationTestmigrationTestmigration: load(TestMigrationTestmigrationTestmigration, 'testmigration.testmigration'),
